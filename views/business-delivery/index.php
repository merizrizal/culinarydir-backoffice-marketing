...
/* @var $searchModel core\models\search\BusinessDeliverySearch */
...
<div class="business-delivery-index">
    ...
    echo GridView::widget([
        'id' => 'grid-view-business-delivery',
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-business-delivery', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-business-delivery").length > 0) {
    ...
    $(".row-grid-view-business-delivery").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-business-delivery",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-business-delivery").on("shown.bs.popover", function(event) {
