...
/* @var $searchModel core\models\search\BusinessPaymentSearch */
...
<div class="business-payment-index">
    ...
    echo GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-business-payment', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-business-payment").length > 0) {
    ...
    $(".row-grid-view-business-payment").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-business-payment",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-business-payment").on("shown.bs.popover", function(event) {
