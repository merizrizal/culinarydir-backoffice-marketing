...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Promo'), 'url' => ['index', 'id' => $model->business->id]];
$this->params['breadcrumbs'][] = $this->title;

echo $ajaxRequest->component(); ?>

<div class="business-promo-view">
                    ...
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                'attribute' => 'image',
                                'format' => 'raw',
                                'value' => Html::img(Yii::getAlias('@uploadsUrl') . $model->thumb('/img/business_promo/', 'image', 200, 200), ['class'=>'img-thumbnail']),
                            ],
                            'date_start',
                            'date_end',
                            [
